...
function generateVapidKeys() {
  ...
  try {
    ...
    if (fs.existsSync(envPath)) {
      ...
      console.log(
        "⚠️ Não esqueça de configurar VAPID_EMAIL com seu email real.",
      );
      ...
      console.log(
        "⚠️ Configure as demais variáveis no .env conforme necessário.",
      );
    } else {
      console.log(
        "⚠️ Nenhum arquivo .env encontrado. Crie manualmente com as keys acima.",
      );
    }
