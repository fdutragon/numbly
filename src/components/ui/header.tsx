...
export function AppHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950/90 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950/90 shadow-2xl border-b border-gray-800/80 px-2 py-1.5 z-50 backdrop-blur-xl">
