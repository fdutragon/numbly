    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 pb-20 space-y-6">
        ...
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-200 shadow-sm p-6">
          ...
          {isPWAInstalled ? (
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Você já está usando a versão mais avançada do Numbly. Todas as
                funcionalidades estão disponíveis aqui mesmo!
              </p>
              <div className="text-xs text-gray-500 space-y-1">
          ...
          <div className="border-t pt-4">
            <p className="text-xs text-gray-600 text-center mb-3">
              💡 <strong>Dica:</strong> Adicione um atalho no seu telefone para
              acesso ainda mais rápido
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Inspirações baseadas em seus números
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
        ...
        <div className="bg-white rounded-lg border border-red-200 shadow-sm p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Fazer logout irá desconectá-lo de sua conta atual. Você precisará
