      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="relative">
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-16 h-16 bg-gradient-to-br ${numerologySlides[currentSlide].color} rounded-full flex items-center justify-center text-3xl`}>
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                <h3 className="font-medium text-gray-900">Dia Pessoal</h3>
                <p className="text-sm text-gray-600">Vibração do dia</p>
              </div>
              <div className="text-2xl font-bold text-purple-600">{diaPessoalAtual}</div>
            </div>
            
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                <h4 className="font-medium text-gray-900 mb-1">Ano Pessoal</h4>
                <p className="text-lg font-bold text-blue-600">{mapa.anoPessoal}</p>
                <p className="text-xs text-gray-600 mt-1">{getAnoPessoalMessage(mapa.anoPessoal)}</p>
              </div>
              
              <div className="p-4 bg-gray-50 rounded-lg">
                <h4 className="font-medium text-gray-900 mb-1">Mês Pessoal</h4>
                <p className="text-lg font-bold text-green-600">{mapa.mesPessoal}</p>
                <p className="text-xs text-gray-600 mt-1">{getMesPessoalMessage(mapa.mesPessoal)}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                <h3 className="font-medium text-green-900 mb-2">{blogData.dicaEspecial.titulo}</h3>
                <p className="text-sm text-green-800 leading-relaxed">{blogData.dicaEspecial.conteudo}</p>
              </div>
              
              <div className="flex items-center justify-between text-sm text-gray-600">
                <span>Energia dominante: <strong className="text-purple-600">{blogData.energiaDominante}</strong></span>
                <span>Sincronia: <strong className="text-blue-600">{blogData.numeroSincronia}</strong></span>
              </div>
            </div>
          </div>
        )}
