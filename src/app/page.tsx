...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const mapa = gerarMapaNumerologicoCompleto(formData.nome, formData.dataNascimento);
      
      console.log('✅ Cálculos concluídos:', { numeroDestino, mapa });
      
      const userData = {
        nome: formData.nome.trim(),
        dataNascimento: formData.dataNascimento, // Já está no formato brasileiro
        numeroDestino,
