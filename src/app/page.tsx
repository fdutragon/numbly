  ...
  const handleExistingDevice = async () => {
    ...
    try {
      ...
      if (!result.success) {
        setDeviceMessage(
          result.message ||
            "Dispositivo não encontrado. Por favor, faça um novo cadastro.",
        );
        return;
      }
      ...
      if (result.exists) {
        if (!result.hasPush) {
          setDeviceMessage(
            `Bem-vindo de volta ${result.userName}! Configure as notificações para continuar.`,
          );
      ...
      <div className="w-full max-w-md z-10">
        ...
        >
          <img
            ...
            alt="Numbly Oráculo"
            className="w-12 h-12 mx-auto mb-4 rounded-lg border border-neutral-200"
          />
          <h1 className="text-3xl font-bold text-neutral-900 mb-1 tracking-tight">
            Numbly Oráculo!
          </h1>
          <h2 className="text-base font-medium text-neutral-500 mb-2">
            Sua Jornada Numerológica
          </h2>
          <p className="text-neutral-500 text-sm font-normal max-w-md mx-auto mb-1">
            Descubra o poder dos números na sua vida. Cadastre-se e receba um
            mapa numerológico personalizado, dicas e insights exclusivos.
          </p>
        </motion.div>
        {/* Form minimalista */}
        <Card className="border border-neutral-200 bg-white shadow-none px-6 py-8">
          <CardContent className="space-y-4 p-0">
            ...
            >
              ...
              >
                <circle
                  ...
                  strokeWidth="1.5"
                />
                <circle cx="12" cy="12" r="6" stroke="#bbb" strokeWidth="1.5" />
              </svg>
            ...
            <div className="mt-2 flex flex-col items-center gap-1">
              <span className="text-xs text-neutral-500 font-medium mb-1">
                Baixe nosso App{" "}
              ...
              <div className="flex gap-2">
                <a
                  href="#"
                  className="flex items-center gap-2 px-2 py-1 rounded border border-neutral-200 hover:bg-neutral-100 transition text-xs text-neutral-700"
                >
                  <svg
                    width="18"
                    height="18"
                  ...
                  >
                    <path
                      d="M17.6 13.53c-.03-3.36 2.74-4.97 2.86-5.05-1.56-2.28-3.98-2.6-4.83-2.63-2.06-.21-4.02 1.2-5.07 1.2-1.05 0-2.67-1.17-4.4-1.13-2.26.03-4.34 1.32-5.5 3.36-2.36 4.09-.6 10.13 1.7 13.45 1.13 1.62 2.47 3.44 4.23 3.38 1.7-.07 2.34-1.09 4.39-1.09 2.05 0 2.62 1.09 4.4 1.06 1.82-.03 2.96-1.65 4.07-3.28 1.29-1.89 1.82-3.73 1.85-3.82-.04-.02-3.54-1.36-3.57-5.41z"
                      fill="currentColor"
                    />
                    <path
                      d="M15.45 3.98c.89-1.08 1.49-2.59 1.32-4.08-1.28.05-2.83.85-3.75 1.93-.82.97-1.54 2.52-1.27 4 .15.06 2.53.16 3.7-1.85z"
                      fill="currentColor"
                    />
                  </svg>
                  Android
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-neutral-500 mb-4 text-xs">
              Permita notificações para receber orientações personalizadas
              baseadas no seu mapa numerológico.
            </p>
          </div>
